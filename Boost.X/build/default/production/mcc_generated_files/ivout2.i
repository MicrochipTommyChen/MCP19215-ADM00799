# 1 "mcc_generated_files/ivout2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/ivout2.c" 2
# 51 "mcc_generated_files/ivout2.c"
...
# 51 "mcc_generated_files/ivout2.c" 2
...
# 52 "mcc_generated_files/ivout2.c" 2
...
void IVOUT2_SetOutput(uint8_t outputTarget)
{
 ...
 uint8_t pwmStep = 1;
    if (PWM2RL < 0x12)
    {
        ...
        while (PWM2RL != 0x12) {
            PWM2RL += pwmStep;
            _delay((unsigned long)((2774)*(8000000/4000000.0)));
        }
    }
    if (PWM2RL > 0x12)
    {
 ...
 CREFCON2 = 0x7D;
    ...
    if (VREFCON2 < outputTarget)
    {
        ...
        while (VREFCON2 != outputTarget) {
            VREFCON2 += outputStep;
            _delay((unsigned long)((830)*(8000000/4000000.0)));
        }
    }
    if (VREFCON2 > outputTarget)
    {
