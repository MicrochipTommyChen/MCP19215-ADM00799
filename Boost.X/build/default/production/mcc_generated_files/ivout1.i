# 1 "mcc_generated_files/ivout1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/ivout1.c" 2
# 51 "mcc_generated_files/ivout1.c"
...
# 51 "mcc_generated_files/ivout1.c" 2
...
# 52 "mcc_generated_files/ivout1.c" 2
...
void IVOUT1_SetOutput(uint8_t outputTarget)
{
 ...
 uint8_t pwmStep = 1;
    if (PWM1RL < 0x14)
    {
        ...
        while (PWM1RL != 0x14) {
            PWM1RL += pwmStep;
            _delay((unsigned long)((2497)*(8000000/4000000.0)));
        }
    }
    if (PWM1RL > 0x14)
    {
 ...
 CREFCON1 = 0x32;
    ...
    if (VREFCON1 < outputTarget)
    {
        ...
        while (VREFCON1 != outputTarget) {
            VREFCON1 += outputStep;
            _delay((unsigned long)((248)*(8000000/4000000.0)));
        }
    }
    if (VREFCON1 > outputTarget)
    {
